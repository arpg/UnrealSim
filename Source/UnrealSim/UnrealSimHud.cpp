...
AUnrealSimHud::AUnrealSimHud(const FObjectInitializer& ObjectInitializer) 
...
void AUnrealSimHud::DrawHUD()
{
	...
	if( bHMDDeviceActive == false )
	{
		...
		AUnrealSimPawn* Vehicle = Cast<AUnrealSimPawn>(GetOwningPawn());
