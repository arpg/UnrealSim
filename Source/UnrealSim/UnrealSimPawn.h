...
#include "UnrealSimPawn.generated.h"
...
UCLASS(config=Game)
class AUnrealSimPawn : public AWheeledVehicle, public InputListener
{
	GENERATED_BODY()
...
public:
	AUnrealSimPawn(const FObjectInitializer& ObjectInitializer);
	...
	void OnResetVR();
  /** Handle input node messages */
  void OnMessage(const InputMessage& message);
